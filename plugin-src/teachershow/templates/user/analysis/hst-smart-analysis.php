...
?>
<section class="hst-page hst-management-page hst-module hst-module--smart-analysis">
    <div class="hst-card hst-section-card hst-management-card">
        <div class="hst-card__header hst-section-card__header">
            <h3><?php echo esc_html(HST_Settings::management_page_title('smart-analysis', 'تحلیل هوشمند')); ?></h3>
        </div>
